...
then doubles again (6), before growing another meter; at the end of the 4th cycle, its height is 7 meters.
...
public class UtopianTree {
	...
	public static void main(String[] args) {
        ...
        // Formula is if h is initail height and n is no of years then total height after n years 2^n(h + 1) - 1
        for (int i=0; i < noOfInputs ; i ++){
        	int noOfCycles = inputs[i]; 
        	int noOfYears = noOfCycles / 2;
        	Double height = Math.pow(2, noOfYears)*(1 + 1) - 1    ;// initial height h is 1
